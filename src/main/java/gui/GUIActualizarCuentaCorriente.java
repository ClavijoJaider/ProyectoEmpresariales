 ...
 * @author sdlgv
 */
public class GUIActualizarCuentaCorriente extends javax.swing.JFrame implements ICambiable {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        try {
            ...
            double limiteSobreGiro = Double.parseDouble(txtLimitSobreGiro.getText());
            ...
            if (respuesta == javax.swing.JOptionPane.YES_OPTION) {
                service.actualizarCuentaCorriente(numero, titular, limiteSobreGiro, comision);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIActualizarCuentaCorriente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIActualizarCuentaCorriente().setVisible(true);
            }
        });
    }
